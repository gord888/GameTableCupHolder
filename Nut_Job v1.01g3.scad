...
thread_length  					= 68; // total length = thread_length+head_height	
...
nut_thread_outer_diameter     	=  thread_outer_diameter + 1; // + 0.8 may work but a little tighter //9;		
//Thread step or Pitch (2mm works well for most applications ref. ISO262: M3=0.5,M4=0.7,M5=0.8,M6=1,M8=1.25,M10=1.5)
nut_thread_step    				= thread_step; //2;
//Step shape degrees (45 degrees is optimised for most printers ref. ISO262: 30 degrees)
nut_step_shape_degrees 			= step_shape_degrees;//45;	
